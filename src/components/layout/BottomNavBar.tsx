...
const BottomNavBar = () => {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 mx-auto flex w-full max-w-100.5 items-end gap-[12.5px] bg-[#FCFCFC] px-10.5 pt-4.5 pb-4 shadow-[0_-4px_4px_0_rgba(0,0,0,0.04)] rounded-t-[20px] overflow-visible">
